...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlantSpecies.image'
        db.add_column(u'exposition_management_plantspecies', 'image',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlantSpecies.image'
        db.delete_column(u'exposition_management_plantspecies', 'image')
